...
I then experimented with _Scala_, {% include footnotes/footnote_link.html content="_Closure_" count=2 %}, _Haskell_, _Elm_ and _Erlang_ but all of them had issues I simply couldn't stomach. Mostly it was a lack of interoperability with Javascript which is still my _target platform_ of choice, or a lack of _general purpose_ support at language level (I'm looking at you _Elm_).
...
<ol id="footnote" class="footnote fa-ul">
    <li><span class="fa-li"><i class="fas fa-asterisk"></i></span> I suspect this might be less true for <strong>F#</strong> and <strong>Scala</strong>, but they aren't particulalrly good for targeting the Javascript runtime.</li>
    <li><span class="fa-li"><i class="fas fa-asterisk"></i><i class="fas fa-asterisk"></i></span> Closure isn't Statically Typed, but I heard that <strong>thinking in Lisp</strong> encourages safer code. I remain unconvinced.</li>
</ol>